...
function checkOnHorizontal(board, cur_row, cur_col, cur_val) {
    ...
    if ((count_left + count_right === 4 && isBlocked === 0) || (count_left + count_right >= 5)) {
        return 1;
    }
}
...
function checkOnVertically(array_board, cur_row, cur_col, cur_val) {
    ...
    for (let i = cur_row; i < 15; i++) {
        if (array_board[i][cur_col] === cur_val) {
            ...
            if (array_board[i][cur_col] === cur_val*(-1)) {
                isBlocked = 1;
            }
            break;
        }
    ...
    if ((count_up + count_down === 4 && isBlocked === 0) || (count_up + count_down >= 5))  {
        return 1;
    }
}
...
function checkOnDiagonal(array_board, cur_row, cur_col, cur_val) {
    ...
    for (let i = cur_row; i >= 0; i--) {
        if (array_board[i][cur_col + temp1] === cur_val) {
            ...
            if (array_board[i][cur_col + temp1] === cur_val*(-1)) {
                isBlocked = 1;
            }
            break;
        }
    ...
    for (let i = cur_row + 1; i < 15; i++) {
        if (array_board[i][cur_col - temp2] === cur_val) {
            ...
            if (array_board[i][cur_col - temp2] === cur_val*(-1)) {
                isBlocked = 1;
            }
            break;
        }
    }
    if ((count_left_down + count_right_up === 4 && isBlocked === 0) || (count_left_down + count_right_up >= 5)) {
        return 1;
    }
}
...
function checkOnDiagonalMain(array_board, cur_row, cur_col, cur_val) {
    ...
    if ((count_left_up + count_right_down === 4 && isBlocked === 0) || (count_left_up + count_right_down >= 5)) {
        return 1;
    }
}
